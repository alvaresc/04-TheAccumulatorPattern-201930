...
#          what expression would you use in the _____ below?
#
#            for k in range(___(s-10) - (r+4+1)__):
#
...
#                  return count
#
#   should be s - r + 1, start count outside loop, math.cos(r+k), retunr indented too far
#
#     f. The code in the "graphics accumulation" example below includes:
#            for _ in range(n):
#        What does the   _   (underscore) mean?
#  # of times look will run
